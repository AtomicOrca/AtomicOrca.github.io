...
<html lang="es">
    <head>
        ...
        <title>Menu de caja - Offset Sale (OS)</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand js-scroll-trigger" style="color: #1a1a1a;">Caja</a>
        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="container">
                        <h2 class="text-center mt-0">Gestión de caja</h2>
                        <p class="text-white-75 font-weight-light mb-5" id="usuario">Bienvenido: <?php echo "{$_SESSION["os_usuario"]} - {$_SESSION["os_usr_nivel"]}" ?></p>
                        <p class="text-white-75 font-weight-light mb-5">Dentro de esta página podrás utilizar las herramientas para la caja.</p>
                        <hr class="divider my-4" />
                        <div class="row">
                            <a class="col-lg-3 col-md-6 text-center"href="./carrito.php">
                                <div class="mt-5">
                                    <!--i class="fas fa-4x fa-chalkboard-teacher text-primary mb-4"></i-->
                                    <i class="fas fa-4x fa-cash-register text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Carrito</h3>
                                    <p class="text-muted mb-0">Realizar una venta de productos.</p>
                                </div>
                            </a>
                            <a class="col-lg-3 col-md-6 text-center" href="./consultar_ventas.php">
                                <div class="mt-5">
                                    <i class="fas fa-4x fa-solid fa-list-alt text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Ventas realizadas</h3>
                                    <p class="text-muted mb-0">Consultar las ventas realizadas.</p>
                                </div>
                            </a>
                            <a class="col-lg-3 col-md-6 text-center" href="./cortes_caja.php">
                                <div class="mt-5">
                                    <i class="fas fa-4x fa-clipboard-list text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Cortes</h3>
                                    <p class="text-muted mb-0">Consultar o realizar un corte.</p>
                                </div>
                            </a>
                            <a class="col-lg-3 col-md-6 text-center" href="../">
                                <div class="mt-5">
                                    <!--i class="fas fa-4x fa-book text-primary mb-4"></i-->
                                    <i class="fas fa-4x fa-arrow-circle-left text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Regresar a inicio</h3>
                                    <p class="text-muted mb-0">Click aquí para regresar al menú anterior.</p>
                                </div>
                            </a>
                        </div>
                    </div>
