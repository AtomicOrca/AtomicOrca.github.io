...
<html lang="es">
    <head>
        ...
        <title>Consultar ventas - Offset Sale (OS)</title>
        <!-- Favicon-->
        ...
        <script src="./js/func_cventas.js"></script>
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand js-scroll-trigger">-></a>
                <a class="navbar-brand js-scroll-trigger" style="color: #1a1a1a;">Consulta de ventas</a>
        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="container">
                        <h2 class="text-center mt-0">Consulta de ventas</h2>
                        <?php if ( validar_get("id_corte") ) echo "<p>Ventas durante el corte con ID: {$_GET["id_corte"]}</p>" ?>
        ...
        if ($conexion_db) {
            ...
            if ( validar_get("id_corte") ) {
                $consulta = "SELECT c.* from compras c, cortes d where c.fecha_hora between d.fh_inicio and d.fh_fin and d.id={$_GET["id_corte"]}";
            } else {
            ...
            if ($filas->num_rows) {
                while ( $fila = $filas->fetch_array() ) {
                    echo "agregar_venta({$fila['id_compra']}, '{$fila['fecha_hora']}', {$fila['total']}, {$fila['devuelto']}, '{$fila['usuario']}')\n";
                }
            }
            echo "ventas_mostrar = ventas\n";
