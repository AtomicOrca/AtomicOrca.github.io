...
<html lang="es">
    <head>
        ...
        <title>Menu de usuarios - Offset Sale (OS)</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand js-scroll-trigger" style="color: #1a1a1a;">Usuarios</a>
        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="container">
                        <h2 class="text-center mt-0">Gestión de usuarios</h2>
                        <p class="text-white-75 font-weight-light mb-5" id="usuario">Bienvenido: <?php echo "{$_SESSION["os_usuario"]} - {$_SESSION["os_usr_nivel"]}" ?></p>
                        <p class="text-white-75 font-weight-light mb-5">Dentro de esta página podrás utilizar las herramientas gestionar usuarios.</p>
                        <hr class="divider my-4" />
                        <div class="row">
                            <a class="col-lg-3 col-md-6 text-center"href="./registrar_usuario.php">
                                <div class="mt-5">
                                    <!--i class="fas fa-4x fa-chalkboard-teacher text-primary mb-4"></i-->
                                    <i class="fas fa-4x fa-user-plus text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Registro</h3>
                                    <p class="text-muted mb-0">Inventario para registrar un nuevo usuario.</p>
                                </div>
                            </a>
                            <a class="col-lg-3 col-md-6 text-center" href="./consultar_usuarios.php">
                                <div class="mt-5">
                                    <i class="fas fa-4x fa-list text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Consultar</h3>
                                    <p class="text-muted mb-0">Visualizar/modificar usuarios en el sistema.</p>
                                </div>
                            </a>
                            <a class="col-lg-3 col-md-6 text-center" href="./modificar_contra.php">
                                <div class="mt-5">
                                    <i class="fas fa-4x fa-user-edit text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Cambiar contraseña</h3>
                                    <p class="text-muted mb-0">Seccion para cambiar tu contraseña.</p>
                                </div>
                            </a>
