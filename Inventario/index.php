...
<html lang="es">
    <head>
        ...
        <title>Menu de inventario - Offset Sale (OS)</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand js-scroll-trigger" style="color: #1a1a1a;">Inventario</a>
        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="container">
                        <h2 class="text-center mt-0">Gestión de inventario</h2>
                        ...
                        <div class="row">
                            <a class="col-lg-3 col-md-6 text-center"href="./consultar_inventario.php">
                                <div class="mt-5">
                                    ...
                                    <p class="text-muted mb-0">Visualizar productos dentro del inventario.</p>
                                </div>
                            </a>
                            <a class="col-lg-3 col-md-6 text-center" href="./agregar_producto.php">
                                <div class="mt-5">
                                    <i class="fas fa-4x fa-solid fa-plus-circle text-primary mb-4"></i>
                                    <h3 class="h4 mb-2">Agregar producto</h3>
                                    <p class="text-muted mb-0">Formulario para añadir productos.</p>
                                </div>
                            </a>
