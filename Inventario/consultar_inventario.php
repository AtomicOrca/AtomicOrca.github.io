        ...
        <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="container">
                        <h2 class="text-center mt-0">Consulta de inventario</h2>
                    ...
                    <div id="secc_inventario" style="overflow-y: scroll;overflow-x: hidden;height: 50vh;margin: auto;align-content: center;padding: 30px;text-align: center;">
